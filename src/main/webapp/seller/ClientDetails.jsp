                ...
                <div class="content">
                    ...
                    <div class="client-data">
                        ...
                        <div class="row">
                            ...
                            <div id="issueBillButton" class="button" style="cursor: pointer;" onclick="window.location.href='<%=request.getContextPath()%>/bills?id=${client.getId()}&fromjsp=clientdetails&option=show'"> View Client's Bills </div>
                        </div>
                    </div>
