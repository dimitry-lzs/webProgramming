                ...
                <div class="content">
                    ...
                    <div class="client-data">
                        ...
                        <div class="row">
                            ...
                            <div id="issueBillButton" class="button" style="cursor: pointer;" onclick="window.location.href='<%=request.getContextPath()%>/clients?id=${client.getId()}&fromjsp=clientdetails'"> Issue Bill </div>
                        </div>
                    </div>
