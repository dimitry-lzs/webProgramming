                ...
                <div class="content">
                    ...
                    <div class="client-data">
                        ...
                        <div class="row">
                            ...
                            <div id="issueBillButton" class="button" style="cursor: pointer;" onclick="window.location.href='<%=request.getContextPath()%>/bills?action=show&clientId=${client.getId()}'"> View Client's Bills </div>
                        </div>
                    </div>
