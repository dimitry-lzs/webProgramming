        ...
        <section> <span></span> <span></span> <span></span> <span></span> <span></span> <span></span> <span></span>
            ...
            <div class="signin">
                <div class="content">
                    ...
                    <div id="issueBillButton" class="button" style="cursor: pointer;" onclick="window.location.href='<%=request.getContextPath()%>/clients?id=${client.getId()}&fromjsp=monthselect&selectedmonth=' + getMonthValue()  + ''"> Continue To Bill </div>
                    <p> ${referer} </p>
                </div>
            </div>
        </section>
